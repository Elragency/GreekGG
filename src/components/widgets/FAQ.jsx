    ...
    >
      <div className="relative z-10 container px-2 sm:px-8 lg:px-4 mx-auto w-11/12 sm:w-full">
        <div className="md:max-w-4xl mx-auto">
          <p className=" text-center max-w-lg mb-4 text-3xl font-bold leading-none md:tracking-tight sm:text-4xl md:mx-auto font-heading">
            Have any questions?
          </p>
          <h2 className="max-w-3xl mx-auto text-xl text-muted dark:text-slate-400 text-center ">
